...
def run_test_generate_points_on_circle():
    ...
    expected = [rg.Point(300,250), rg.Point(200, 350), rg.Point(100, 250), rg.Point(200, 150)]
...
def run_test_pizza():
    ...
    # Test 4:
    title = 'PIZZA test 4:  2 slices, thin (thickness=1) yellow lines.'
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(100, 200), 100)
    circle.outline_thickness = 1
    pizza(window, circle, 2, 'yellow', 3)
    window.close_on_mouse_click()
...
def run_test_polygon():
    ...
    title1 = 'POLYGON tests 3: 4 segments with thin green lines.'
    window1 = rg.RoseWindow(550, 400, title1)

    circle1 = rg.Circle(rg.Point(200,200), 100)
    circle1.outline_thickness = 4
    polygon(window1, circle1, 4, 'green', 2)
...
def run_test_fancy_polygon():
    ...
    circle = rg.Circle(rg.Point(200, 200), 150)
    circle.fill_color = 'blue'
    fancy_polygon(window, circle, 20, 5, 'lime green', 3)
    window.close_on_mouse_click()
